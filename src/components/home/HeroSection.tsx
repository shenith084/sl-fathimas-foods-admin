...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#FAF7F2] via-[#F4EFE6] to-[#FAF7F2] min-h-[580px] md:min-h-[680px]">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#556B4F]/5 rounded-full -translate-y-1/2 translate-x-1/4 blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-16 lg:py-20 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 relative flex items-center justify-center">
            {/* Trust badge */}
            <div className="absolute top-0 right-0 md:-top-4 md:-right-4 z-20 bg-[#FAF7F2] border border-[#556B4F]/20 text-[#222] rounded-full w-24 h-24 md:w-28 md:h-28 flex flex-col items-center justify-center text-center shadow-md">
            ...
            <div className="relative w-full max-w-[550px] mx-auto">
              <div className="absolute inset-0 bg-[#556B4F]/5 rounded-[3rem] blur-2xl -z-10" />
