  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h2 className="text-2xl font-bold text-[#222]">Add New Category</h2>
      </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="e.g. Ghee Rice Combo Kit"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D98C1F]/20 focus:border-[#D98C1F] transition-all"
                placeholder="e.g. ghee-rice-combo-kit"
              />
              <p className="text-xs text-gray-500 mt-1">This will be used in the URL.</p>
            </div>
